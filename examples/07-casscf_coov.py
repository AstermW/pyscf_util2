...
res2 = iciscf_kernel(mol2, mf2, nelec, norb, _ici_state=[[2, 2, 1], [2, 3, 1]])
res2 = iciscf_kernel(mol2, mf2, nelec, norb, _ici_state=[[0, 0, 1]])
res2 = casscf_kernel(mol2, mf2, nelec, norb, _pyscf_state=[[0, 0, 1]])
res2 = iciscf_kernel(mol2, mf2, nelec, norb, _ici_state=[[0, 2, 1], [0, 3, 1]])
res2 = casscf_kernel(mol2, mf2, nelec, norb, _pyscf_state=[[0, 2, 1], [0, 3, 1]])
